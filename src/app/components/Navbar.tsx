...
function Navbar() {
  return (
    <div className="bg-blue-900 flex h-20 justify-between items-center sticky top-0">
    
      <div className=" text-white text-xl flex h-16 justify-start items-center">
        <Image src={logo} alt="Company Logo" width={200} height={200} className="ml-9 w-16 hover:w-24 hover:transition-all hover:cursor-pointer rounded-full"/>
